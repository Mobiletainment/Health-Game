...
{
	private static int[] LevelDurationConfig = new int[] { 58, 70, 70, 60, 75, 90, 90, 90, 90 }; //Level 1 = 15s, Level2 = 30s, etc.
	private static int[] RuleChangeConfig = new int[] { 1, 2, 3, 6, 3, 6, 6, 3, 3 }; //Level 1 = 1 Rule, Level 2 = 2 Rules, etc.
	private static int[] PositiveItemCountConfig = new int[] { 20, 12, 18, 28, 40 }; //Level 1 = 8 good Items in total, etc.
