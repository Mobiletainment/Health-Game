...
<a href='#rewardingame?reward=salad' onclick='customData.data=\"salad\"; customData.referral=window.location.hash' data-role='button' data-theme='b'>Salatblatt<br>Energieschub</a><a href='#rewardingame?reward=snail' onclick='customData=\"snail\"' data-role='button' data-theme='b'>Schnecke<br>Kurzfristige Verlangsamung</a><a href='#rewardingame?reward=sight' onclick='customData=\"sight\"' data-role='button' data-theme='b'>Brille<br>Kurzfristige freie Sicht</a><a href='#rewardingame?reward=life' onclick='customData=\"life\"' data-role='button' data-theme='b'>+1 Leben<br>Ein extra Leben</a></div>\n\
